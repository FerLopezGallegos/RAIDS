...
public class Raid6Controller implements Serializable {
    ...
    public void crearArchivosSegmento(int iteracion, String nombre) {
        ...
        BloqueRaid6 bloque1 = new Raid6Controller.BloqueRaid6(iteracion, segmentos.size(), TipoRaid.RAID5, seg1, nombre, TipoBloque.NORMAL);
        BloqueRaid6 bloque2 = new Raid6Controller.BloqueRaid6(iteracion, segmentos.size(), TipoRaid.RAID5, seg2, nombre, TipoBloque.NORMAL);
        BloqueRaid6 bloque3 = new Raid6Controller.BloqueRaid6(iteracion, segmentos.size(), TipoRaid.RAID5, paridad, nombre, TipoBloque.PARIDAD);
